...
ratios1 = (1.2, )
t_list1 = np.linspace(0, 4000, 21)
n1, entr1 = entropy_utils_svac.entropy_vs_ratio( \
...
n1_df.to_csv('./data/40_svac_n1_df.csv', index=False)
entr1_df.to_csv('./data/40_svac_entr1_df.csv', index=False)
...
# ratios2 = (1.6, 2, 4)
# t_list2 = np.linspace(0, 2000, 51)
# n2, entr2 = entropy_utils_svac.entropy_vs_ratio( \
...
# n2_df.to_csv('./data/40_svac_n2_df.csv', index=False)
# entr2_df.to_csv('./data/40_svac_entr2_df.csv', index=False)
...
# ratios3 = (8, 16, 64, 256)
# t_list3 = np.linspace(0, 1000, 51)
# n3, entr3 = entropy_utils_svac.entropy_vs_ratio( \
...
# n3_df.to_csv('./data/40_svac_n3_df.csv', index=False)
# entr3_df.to_csv('./data/40_svac_entr3_df.csv', index=False)
